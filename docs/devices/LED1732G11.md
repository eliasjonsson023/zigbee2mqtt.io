...
```
## CC2531 and the E1745
It is confirmed that the E1745 does not work properly with the older CC2531 firmware version 20180507. No occupancy events are received from the motion sensor. This issue is however fixed in the 20201127 firmware version.
{% endraw %}
